  ...
  return (
    <Container style={styles.ContainerStyle}>
      ...
      <View style={styles.midcontainer}>
        <Text style={styles.HeadTextStyle}>Let's Sign you in</Text>
        ...
        <Toast />
        <TouchableOpacity onPress={SignWithEmail} style={styles.button}>
          <Text style={styles.TextButtonStyle}>Sign In</Text>
        </TouchableOpacity>

        <View style={styles.LastViewStyle}>
          <Text style={styles.Grey83Color}>You do have an account ?</Text>
          <TouchableOpacity onPress={() => navigation.navigate('Login')}>
            <Text style={styles.SkyColor}> Login</Text>
          </TouchableOpacity>
        </View>
        {/*/////////////////////////////middle/////////////////////////////*/}
        {/* <Button></Button> */}
